...
$row=$connessione->query("insert into colf values ('".$_POST['cf']."','".$_POST['nome']."','".$_POST['cognome']."','".$_POST['età']."','".$_POST['città']."','".$_POST['cap']."','".$_POST['email']."','".$password."','".$_POST['cellulare']."');");
if($row==TRUE)
{
...
$connessione->close();
	...
	header('location:registrazionecolf.html');
?>
