...
$email=$_POST['email'];
if($row3=$connessione->query("select * from sceglie where colf='".$_SESSION['cf']."';")==TRUE and $row4=$connessione->query("select * from propone where colf='".$_SESSION['cf']."';")==TRUE and $row5=$connessione->query("select * from riguardo where colf='".$_SESSION['cf']."';")==TRUE )
{
$row=$connessione->query("delete from sceglie where colf='".$_SESSION['cf']."';");
$row=$connessione->query(" delete from propone where colf='".$_SESSION['cf']."';");
$row=$connessione->query(" delete from riguardo where id='".$_SESSION['cf']."';");
$row=$connessione->query(" delete from colf where cf='".$_SESSION['cf']."';");
}
elseif($row3=$connessione->query("select * from sceglie where colf='".$_SESSION['cf']."';")==TRUE)
{
$row=$connessione->query("delete from sceglie where colf='".$_SESSION['cf']."';");
$row=$connessione->query(" delete from colf where cf='".$_SESSION['cf']."';"); 
}
elseif( $row4=$connessione->query("select * from propone where colf='".$_SESSION['cf']."';")==TRUE )
{
$row=$connessione->query(" delete from propone where colf='".$_SESSION['cf']."';");
$row=$connessione->query(" delete from colf where cf='".$_SESSION['cf']."';"); 
}
elseif( $row5=$connessione->query("select * from riguardo where colf='".$_SESSION['cf']."';")==TRUE )
{

$row=$connessione->query(" delete from riguardo where cf='".$_SESSION['cf']."';");
$row=$connessione->query(" delete from colf where cf='".$_SESSION['cf']."';");
}
else
$row=$connessione->query(" delete from colf where cf='".$_SESSION['cf']."';");
...
header("location:deletecolf.html");
$connessione->close();
